...
echo "Instances , Throughput , Responsetime , TOTAL_PODS_MEM , TOTAL_PODS_CPU , CPU_MIN , CPU_MAX , MEM_MIN , MEM_MAX , CLUSTER_MEM% , CLUSTER_CPU% , CPU_REQ , MEM_REQ , WEB_ERRORS , MAXINLINELEVEL" > ${RESULTS_DIR_ROOT}/Metrics.log
...
echo "Instances , CI_Throughput , CI_Responsetime , CI_TOTAL_PODS_MEM , CI_TOTAL_PODS_CPU , CI_WEB_ERRORS" > ${RESULTS_DIR_ROOT}/Metrics-ci.log
